...
export default function Home() {
	return (
		<main class="text-center mx-auto text-gray-700 p-4 gap-2 flex flex-col items-center justify-center">
			...
			/>
			<h1 class="max-6-xs text-6xl uppercase my-16">Hello there!</h1>
			<p class="text-2xl">
